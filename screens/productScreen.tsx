...
const DetailPage = ({ product: productProp, similarProduct, navigation }: any) => {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.info}>
        ...
        <Text>{productProp?.description}</Text>
        ...
        <View style={styles.row}>
          {productProp?.variants?.map((v:any, i:any) => (
            <TouchableOpacity
              ...
              style={[
                styles.variant,
                i === variant && styles.activeVariant,
              ]}
            >
